...
Status: `P1-A, P1-B AND P1-D WORKFLOW BEFORE/AFTER RECORDED`
...
The workflow-level part of P1-D is reduced, but full ingestion idempotency is not closed until an application/DB-level guard is added and tested.

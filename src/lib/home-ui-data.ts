...
export const MARKET_PULSE_ITEMS = [
  {
    title: "Yerba bajó 7.4%",
    description: "Respecto al promedio de la última semana.",
    value: "-7.4%",
    tone: "green",
    points: "4,14 16,20 28,12 40,28 52,18 64,34 76,38",
  },
  {
    title: "Aceite con rango amplio",
    description: "Diferencia de hasta $750 entre supermercados.",
    value: "+$750",
    tone: "amber",
  ...
  {
    title: "Leche estable",
    description: "Variación promedio menor al 1%.",
    value: "-0.6%",
    tone: "green",

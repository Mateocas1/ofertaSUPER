...
- Remaining U16-T2 slice: search; product list/detail/history; categories (static taxonomy only, without protected counts); promotions; catalog health; and the `catalog`, `product-history`, `portfolio-catalog`, and `price-freshness` shared consumers.
